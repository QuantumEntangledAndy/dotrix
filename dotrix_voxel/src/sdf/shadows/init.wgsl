//! Init the Shadows textures buffers on the gpu
//!
//! The textures are init with 0. meaning no shadow
//! Each ping/pong the shadow values increase (but never more than 1.0 - (ambient light))
//!
...
fn cs_main([[builtin(global_invocation_id)]] global_invocation_id: vec3<u32>) {
  ...
  textureStore(shadow_buffer, tex_coords, vec4<f32>(0.));
}
